...
SPIDER_MODULES = ['ltn.spiders']
NEWSPIDER_MODULE = 'ltn.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    # 'ltn.middlewares.ProxyMiddleware': 1,
    # 'ltn.middlewares.RetryMiddleware': 110,
    'ltn.middlewares.RotateUserAgentMiddleware': 3,
